...
function Home() {
  return (
    <div className="flex flex-col min-h-screen">
      <div className="relative h-[60vh] px-4 pt-4">
        <div className="relative h-full rounded-xl overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white bg-black bg-opacity-40">
            <h1 className="text-5xl font-bold mb-6 text-center px-4 sm:text-3xl md:text-5xl">
              想不到去哪裡?遊地圖幫你決定!
            </h1>
            <Link
              to="/map"
              className="bg-[#ff7a59] text-[#fffdf5] py-3 px-8 rounded-lg text-lg transition-colors duration-300 hover:bg-[#e86a48]"
            >
              開始使用
            </Link>
          </div>
